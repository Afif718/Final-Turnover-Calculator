...
//   + " " + B25.value + " " + C25.value + " " + B26.value + " " + C26.value);
  ...
  // console.log("F45 from Section5: " + F45);
   ...
   //final Result 
   var E49 = (F27 + F31 + Number(F38) + F45).toFixed(0); //Total Turnover Cost (RM) for one employee
  ...
  // console.log("E50 Final2 " + E50 + " %");
   var E51 = (E49 * Number(B6.value)).toFixed(0); //Estimated Annual Turnover Cost (RM) 
   //console.log("E51 Final3 " + E51);

    
    //Output results 
    document.getElementById("endoutput1E49").value = "$"+E49.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,");
    document.getElementById("endoutput2E50").value = E50+ "%";
    document.getElementById("endoutput3E51").value = "$"+E51.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,");
...
function SetDefaultValue(){
 ...
 // var defaultB26 = document.getElementById("B26").value = 1;
  ...
  var defaultB31 = document.getElementById("B31").value = 20;
  ...
  var defaultB44 = document.getElementById("B44").value = 30;
      ...
      //Go Back To Top from Bottom Button
function scrollwin(){
...
document.getElementById('goToInputs').addEventListener("click", scrollwin);

//this will trigger auto calculation when GO TO Inputs button clicked
document.getElementById('goToInputs').addEventListener("click", finalCalculationButton);
